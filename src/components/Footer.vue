      ...
      >
        <div class="col-span-full  lg:col-span-2 lg:mb-0">
          <a href="#" class="flex justify-center lg:justify-start">
           <img class="h-auto min-w-[200px] max-w-[270px] rounded-2xl border-2 border-black " :src="logo" alt="My logo" />
          </a>
          <p
            class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left"
          >
            Với chúng tôi công nghệ là tất cả , những gì mới nhất , tốt nhất hiện đại nhất sẽ đến tay bạn .
          </p>
          <div
            class="flex mt-4 space-x-4 justify-center lg:justify-start sm:mt-0"
          >
            <a
              href="javascript:;"
              class="w-9 h-9 rounded-full bg-red-500 flex justify-center items-center hover:bg-indigo-600"
            >
              <svg
                class="text-white"
        ...
        <!--End Col-->
        <div class="hidden lg:block lg:mx-auto text-center sm:text-left ">
          <h4 class="text-lg text-gray-900 font-medium mb-7">GizmoShop</h4>
        ...
        <!--End Col-->
        <div class="lg:mx-auto text-center sm:text-left hidden lg:block  ">
      ...
      <div class="py-7 border-t border-gray-200">
        ...
        >
          <span class="text-sm text-gray-500"
            >©<a href="#">GizmoShop</a>2024, All rights reserved.</span
          >
          <ul class="flex items-center gap-9 mt-4 lg:mt-0">
            <li>
              <a href="javascript:;" class="text-sm text-gray-500">Terms</a>
            </li>
            <li>
              <a href="javascript:;" class="text-sm text-gray-500">Privacy</a>
            </li>
            <li>
              <a href="javascript:;" class="text-sm text-gray-500">Cookies</a>
            </li>
          </ul>
        </div>
      </div>
...
export default {
  data() {
    return {
      logo: require("@/assets/gizmoshop1.png"),
    };
  },
};
</script>